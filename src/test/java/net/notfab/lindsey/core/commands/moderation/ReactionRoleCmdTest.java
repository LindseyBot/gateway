...
class ReactionRoleCmdTest {

    private ReactionRoleCmd command;

    @BeforeEach
    void setUp() {
        command = mock(ReactionRoleCmd.class);
    ...
    void getInfo() {
        ...
        assertEquals("reactionroles", info.getName(), "Name must be reactionroles");
    ...
    void help() {
        ...
        HelpPage page = article.get("reactionroles");
